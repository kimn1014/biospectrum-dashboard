...
export const guides: Guide[] = [
  ...
  {
    id: '4',
    titleKo: 'Claude AI 활용 가이드',
    titleEn: 'Claude AI Usage Guide',
    descriptionKo: 'Claude AI를 업무 및 일상에서 활용하는 방법 안내',
    descriptionEn: 'Guide for using Claude AI in work and daily life',
    icon: 'bot',
    slug: 'claude-guide',
    sections: [
      {
        id: 'intro',
        titleKo: 'Claude AI 소개',
        titleEn: 'Introduction to Claude AI',
        descriptionKo: 'Claude는 Anthropic에서 개발한 AI 어시스턴트입니다. 자연어 대화를 통해 다양한 업무를 지원하며, 텍스트 작성, 분석, 코딩, 번역 등 폭넓은 작업을 수행할 수 있습니다.',
        descriptionEn: 'Claude is an AI assistant developed by Anthropic. It supports various tasks through natural language conversation, including writing, analysis, coding, translation, and more.',
        contentBlocks: [
          {
            type: 'callout',
            calloutType: 'info',
            textKo: 'Claude는 claude.ai 또는 모바일 앱(iOS/Android)에서 무료로 사용할 수 있으며, Pro 플랜을 통해 더 많은 기능을 이용할 수 있습니다.',
            textEn: 'Claude is available for free at claude.ai or mobile apps (iOS/Android), with more features available through the Pro plan.'
          }
        ]
      },
      {
        id: 'work-writing',
        titleKo: '업무 활용 — 문서 작성',
        titleEn: 'Work Usage — Document Writing',
        descriptionKo: '이메일, 보고서, 제안서 등 업무 문서를 빠르게 작성할 수 있습니다.',
        descriptionEn: 'Quickly draft business documents such as emails, reports, and proposals.',
        bulletPointsKo: [
          '비즈니스 이메일 초안 작성 (거래처 회신, 미팅 요청, 공지 등)',
          '보고서 / 제안서 구조 잡기 및 초안 작성',
          '회의록 정리 및 요약',
          '공지사항, 안내문 등 사내 문서 작성'
        ],
        bulletPointsEn: [
          'Draft business emails (client replies, meeting requests, announcements)',
          'Structure and draft reports and proposals',
          'Organize and summarize meeting notes',
          'Write internal documents such as notices and guidelines'
        ],
        contentBlocks: [
          {
            type: 'callout',
            calloutType: 'success',
            textKo: '예시 프롬프트: "거래처에 납기일 변경 요청하는 정중한 이메일 초안을 작성해줘. 기존 납기일은 2월 15일이고, 2월 28일로 변경 요청할거야."',
            textEn: 'Example prompt: "Draft a polite email requesting a delivery date change to a supplier. Original date is Feb 15, requesting change to Feb 28."'
          }
        ]
      },
      {
        id: 'work-data',
        titleKo: '업무 활용 — 데이터 분석 및 정리',
        titleEn: 'Work Usage — Data Analysis & Organization',
        descriptionKo: '데이터를 분석하고, 요약하고, 정리하는 작업을 지원합니다.',
        descriptionEn: 'Supports analyzing, summarizing, and organizing data.',
        bulletPointsKo: [
          '엑셀/CSV 데이터를 붙여넣으면 패턴 분석 및 인사이트 도출',
          '긴 문서나 기사를 요약하여 핵심 내용 추출',
          '경쟁사 분석, 시장 조사 자료 정리',
          '설문 결과, 고객 피드백 분류 및 분석'
        ],
        bulletPointsEn: [
          'Paste Excel/CSV data for pattern analysis and insights',
          'Summarize long documents or articles to extract key points',
          'Organize competitor analysis and market research materials',
          'Classify and analyze survey results and customer feedback'
        ],
        contentBlocks: [
          {
            type: 'callout',
            calloutType: 'success',
            textKo: '예시 프롬프트: "아래 고객 리뷰 데이터에서 긍정/부정 의견을 분류하고, 주요 불만 사항 TOP 5를 정리해줘."',
            textEn: 'Example prompt: "Classify the customer reviews below into positive/negative and list the top 5 complaints."'
          }
        ]
      },
      {
        id: 'work-translation',
        titleKo: '업무 활용 — 번역 및 다국어 지원',
        titleEn: 'Work Usage — Translation & Multilingual Support',
        descriptionKo: '자연스러운 번역과 다국어 콘텐츠 작성을 지원합니다.',
        descriptionEn: 'Supports natural translation and multilingual content creation.',
        bulletPointsKo: [
          '비즈니스 문서 한/영 번역 (이메일, 계약서, 제품 설명 등)',
          '제품 상세 페이지 다국어 콘텐츠 작성',
          '해외 거래처 커뮤니케이션 초안 작성',
          '전문 용어가 포함된 기술 문서 번역'
        ],
        bulletPointsEn: [
          'Translate business documents KR/EN (emails, contracts, product descriptions)',
          'Create multilingual content for product detail pages',
          'Draft communications with overseas partners',
          'Translate technical documents with industry terminology'
        ]
      },
      {
        id: 'work-planning',
        titleKo: '업무 활용 — 기획 및 브레인스토밍',
        titleEn: 'Work Usage — Planning & Brainstorming',
        descriptionKo: '아이디어 발굴, 전략 수립, 기획 초안 작성을 도와줍니다.',
        descriptionEn: 'Helps with idea generation, strategy development, and planning drafts.',
        bulletPointsKo: [
          '신제품 마케팅 전략 아이디어 브레인스토밍',
          '프로젝트 계획 수립 및 일정 구조화',
          'SWOT 분석, 비즈니스 모델 캔버스 작성 지원',
          '프레젠테이션 슬라이드 구조 및 내용 기획'
        ],
        bulletPointsEn: [
          'Brainstorm new product marketing strategy ideas',
          'Develop project plans and structure schedules',
          'Support SWOT analysis and business model canvas creation',
          'Plan presentation slide structure and content'
        ],
        contentBlocks: [
          {
            type: 'callout',
            calloutType: 'success',
            textKo: '예시 프롬프트: "화장품 원료 B2B 전시회 참가를 위한 부스 컨셉과 홍보 전략을 제안해줘."',
            textEn: 'Example prompt: "Suggest booth concepts and promotional strategies for a cosmetic ingredient B2B exhibition."'
          }
        ]
      },
      {
        id: 'personal-learning',
        titleKo: '업무 외 활용 — 학습 및 자기개발',
        titleEn: 'Personal Usage — Learning & Self-development',
        descriptionKo: '새로운 지식을 배우거나, 이해하기 어려운 개념을 쉽게 설명받을 수 있습니다.',
        descriptionEn: 'Learn new knowledge or get easy explanations of difficult concepts.',
        bulletPointsKo: [
          '어려운 개념을 쉬운 말로 설명받기 (경제, 과학, IT 등)',
          '외국어 학습 — 문법 교정, 표현 추천, 회화 연습',
          '자격증/시험 준비 — 개념 정리, 퀴즈 출제',
          '독서 후 핵심 내용 정리 및 토론 상대'
        ],
        bulletPointsEn: [
          'Get difficult concepts explained simply (economics, science, IT, etc.)',
          'Language learning — grammar correction, expression suggestions, conversation practice',
          'Certification/exam prep — concept summaries, quiz generation',
          'Post-reading summaries and discussion partner'
        ],
        contentBlocks: [
          {
            type: 'callout',
            calloutType: 'success',
            textKo: '예시 프롬프트: "블록체인 기술을 중학생도 이해할 수 있게 쉽게 설명해줘."',
            textEn: 'Example prompt: "Explain blockchain technology in a way a middle school student can understand."'
          }
        ]
      },
      {
        id: 'personal-creative',
        titleKo: '업무 외 활용 — 창작 및 콘텐츠',
        titleEn: 'Personal Usage — Creative & Content',
        descriptionKo: '글쓰기, 콘텐츠 제작, 창작 활동에 활용할 수 있습니다.',
        descriptionEn: 'Use for writing, content creation, and creative activities.',
        bulletPointsKo: [
          'SNS 게시물, 블로그 글 작성 및 아이디어 제안',
          '유튜브 스크립트, 쇼츠 대본 작성',
          '소설, 시, 에세이 등 창작 글쓰기 보조',
          '여행 일정 계획 및 맛집/관광지 추천'
        ],
        bulletPointsEn: [
          'Write and get ideas for SNS posts and blog articles',
          'Write YouTube scripts and shorts scripts',
          'Assist with creative writing — fiction, poetry, essays',
          'Plan travel itineraries and get restaurant/attraction recommendations'
        ]
      },
      {
        id: 'personal-daily',
        titleKo: '업무 외 활용 — 일상 생활',
        titleEn: 'Personal Usage — Daily Life',
        descriptionKo: '생활 속 다양한 상황에서 도움을 받을 수 있습니다.',
        descriptionEn: 'Get help in various everyday situations.',
        bulletPointsKo: [
          '요리 레시피 추천 및 냉장고 재료 기반 메뉴 제안',
          '운동 루틴, 식단 계획 작성',
          '쇼핑 시 제품 비교 분석 및 추천',
          '이사, 인테리어 등 생활 계획 수립',
          '편지, 축사, 감사 인사 등 개인 문서 작성'
        ],
        bulletPointsEn: [
          'Recipe recommendations and menu suggestions based on available ingredients',
          'Create workout routines and meal plans',
          'Product comparison analysis and recommendations when shopping',
          'Life planning for moving, interior design, etc.',
          'Write personal documents — letters, speeches, thank-you notes'
        ],
        contentBlocks: [
          {
            type: 'callout',
            calloutType: 'success',
            textKo: '예시 프롬프트: "냉장고에 닭가슴살, 양파, 파프리카, 간장이 있어. 이걸로 만들 수 있는 간단한 저녁 메뉴 3가지 추천해줘."',
            textEn: 'Example prompt: "I have chicken breast, onion, paprika, and soy sauce in my fridge. Recommend 3 simple dinner menus I can make."'
          }
        ]
      },
      {
        id: 'personal-coding',
        titleKo: '업무 외 활용 — 코딩 및 기술 지원',
        titleEn: 'Personal Usage — Coding & Tech Support',
        descriptionKo: '개인 프로젝트나 기술적인 문제 해결에 도움을 받을 수 있습니다.',
        descriptionEn: 'Get help with personal projects or technical problem-solving.',
        bulletPointsKo: [
          '엑셀 수식, 함수 작성 도움 (VLOOKUP, 피벗테이블 등)',
          '간단한 자동화 스크립트 작성 (파일 정리, 데이터 변환 등)',
          '컴퓨터/스마트폰 문제 해결 가이드',
          '개인 웹사이트, 블로그 제작 도움'
        ],
        bulletPointsEn: [
          'Help with Excel formulas and functions (VLOOKUP, pivot tables, etc.)',
          'Write simple automation scripts (file organization, data conversion)',
          'Computer/smartphone troubleshooting guides',
          'Help creating personal websites and blogs'
        ],
        contentBlocks: [
          {
            type: 'callout',
            calloutType: 'success',
            textKo: '예시 프롬프트: "엑셀에서 A열의 이름을 기준으로 B열의 점수를 가져오는 VLOOKUP 수식을 알려줘."',
            textEn: 'Example prompt: "Show me a VLOOKUP formula in Excel that retrieves scores from column B based on names in column A."'
          }
        ]
      },
      {
        ...
        descriptionKo: 'Claude를 더 잘 활용하기 위한 팁입니다.',
        descriptionEn: 'Tips for getting the most out of Claude.',
        bulletPointsKo: [
          '구체적으로 질문할수록 더 정확한 답변을 받을 수 있습니다',
          '맥락(배경 정보)을 충분히 제공하면 더 좋은 결과물이 나옵니다',
          '결과물이 마음에 들지 않으면 "좀 더 간결하게" / "좀 더 격식 있게" 등 수정 요청이 가능합니다',
          '파일(이미지, PDF)을 첨부하여 분석을 요청할 수 있습니다',
          '한 대화에서 이어서 질문하면 맥락을 기억하므로 연속 작업이 가능합니다'
        ],
        bulletPointsEn: [
          'The more specific your question, the more accurate the answer',
          'Providing sufficient context and background leads to better results',
          'You can request revisions like "make it more concise" or "make it more formal"',
          'You can attach files (images, PDFs) for analysis',
          'Continuing in the same conversation retains context for sequential tasks'
        ],
        contentBlocks: [
          {
            type: 'callout',
            calloutType: 'info',
            textKo: '접속: claude.ai 또는 앱스토어/플레이스토어에서 "Claude" 검색 후 설치',
            textEn: 'Access: claude.ai or search "Claude" in App Store/Play Store'
          }
        ]
      }
    ]
